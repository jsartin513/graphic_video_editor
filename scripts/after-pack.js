...
exports.default = async function(context) {
  ...
  // Test videos are for local development only — never copy into friend/release builds
  // unless INCLUDE_TEST_VIDEOS=true.
  if (process.env.INCLUDE_TEST_VIDEOS === 'true') {
